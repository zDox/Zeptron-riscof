...
class Zeptron(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(config['PATH'] if 'PATH' in config else "","Zeptron")
    ...
    def build(self, isa_yaml, platform_yaml):
      ...
      # for Zeptron start building the '--isa' argument. the self.isa is dutnmae specific and may not be
      # useful for all DUTs
